              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-[#E3E8EE] bg-[#F6F9FC]">
                    ...
                    <th className="text-right px-6 py-3.5 text-xs font-semibold text-[#8898AA] uppercase tracking-wider">Actions</th>
                  </tr>
                </thead>
                <tbody>
                  {faculty.map((f, i) => (
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center justify-end gap-2">
                          <button
                            ...
                            className="inline-flex items-center gap-1 text-xs text-[#635BFF] hover:text-[#5851DB] border border-[#635BFF]/30 hover:border-[#635BFF] hover:bg-[#F0F0FF] px-2.5 py-1 rounded-lg transition-colors whitespace-nowrap"
                          >
